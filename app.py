...
<style>
    ...
    .forensic-table th { background: #222; color: white; padding: 12px; text-align: left; font-size: 14px; }
    .forensic-table td { padding: 10px; border-bottom: 1px solid #eee; font-size: 14px; color: #333; }
    ...
    /* STRATEGY CARDS */
    .strat-card {
        background: white; padding: 15px; border-radius: 8px; border-left: 5px solid #E50914;
...
def calculate_cpm(text, duration):
    """Menghitung Kecepatan Ketik (Characters Per Minute)"""
